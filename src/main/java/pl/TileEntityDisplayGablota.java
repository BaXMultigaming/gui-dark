...
public class TileEntityDisplayGablota extends TileEntity implements IInventory {
	...
	public TileEntityDisplayGablota() {
	}
	...
	public String getModelTexture() {
		return "dodatki:textures/blocks/gablota.png";
	}

...
public class ModelGablota extends ModelBase
{
	...
	public void render(TileEntity te, double x, double y, double z) {
		TileEntityDisplayGablota es = (TileEntityDisplayGablota)te;
		...
		ResourceLocation rl = new ResourceLocation("dodatki:textures/blocks/gablota.png");
